#TestCode_05
#User input function added
#Last updated 2019-04-23 12 PM
...
def user_input():
    ...
    x = True;
    while x is True:
        print("Please enter the year of the day you want to examine \n Choose 2016, 2017, 2018, or 2019")
        inputyear = input("yyyy >")
        if (inputyear == '2016') | (inputyear == '2017') | (inputyear == '2018') | (inputyear == '2019'):
            # Later changed to only be 2018 and 2019 as formatting from NY ISO has changed from 2017 to 2018
            x = False
    #Accept Month
    x = True;
    while x is  True:
    ...
    x = True
    #print(datetime.datetime(int(inputyear), int(inputmonth), 22))
    while x is True:
